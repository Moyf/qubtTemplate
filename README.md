...
```shell
git clone https://github.com/Moyf/qubtTemplate
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/qubtTemplate/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://Moyf.github.io/qubtTemplate'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/Moyf/qubtTemplate
  - link: https://github.com/Moyf/qubtTemplate#readme
...
`https://Moyf.github.io/qubtTemplate`